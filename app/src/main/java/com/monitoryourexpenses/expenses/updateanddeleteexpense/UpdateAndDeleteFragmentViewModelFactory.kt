...
class UpdateAndDeleteFragmentViewModelFactory(private val expenses: Expenses, private val application: Application):ViewModelProvider.Factory {
    @Suppress("unchecked_cast")
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(UpdateAndDeleteFragmentViewModel::class.java)) {
            return UpdateAndDeleteFragmentViewModel(expenses, application) as T
        }
